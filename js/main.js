...
(function () {
	...
	a.init = function () {
		...
		root.svg = d3.select(".shape1").append("svg").attr('id', 'viz')
			.attr("style", "fill: #e00069;width: 215px;height: 215px;")

		root.svg1 = d3.select(".shape2").append("svg").attr('id', 'viz')
			.attr("style", "fill:#d3d655;width: 215px;height: 215px;")

		root.svg2 = d3.select(".shape3").append("svg").attr('id', 'viz')
			.attr("style", "fill: #839c9a;width: 215px;height: 215px;")

		root.svg3 = d3.select(".shape4").append("svg").attr('id', 'viz')
			.attr("style", "fill: #009db1;width: 215px;height: 215px;")


		// root.svg1 = d3.select("body").append("svg").attr('id', 'viz1')
		// 		.attr("width", State.width / 2 )
		// 		.attr("height", State.height / 2);
	...
	r.circle = function () {
		...
		root.bars1 = svg1.selectAll("circle")
			.data(WAVE_DATA, function (d) { return d; });
		root.bars2 = svg2.selectAll("circle")
			.data(WAVE_DATA, function (d) { return d; });
		root.bars3 = svg3.selectAll("circle")
			.data(WAVE_DATA, function (d) { return d; });
		...
		bars.enter().append("circle")
			...
			.attr("cy", function (d, i) { return '50%'; })
			.attr("cx", function (d, i) { return '50%'; })
			.attr("r", function (d) { return x(d / 4) + ""; });

		bars3.enter().append("circle")
			.attr('transform', "scale(" + slideScale(State.sliderVal) + ")")
			.attr("cy", function (d, i) { return '50%'; })
			.attr("cx", function (d, i) { return '50%'; })
			.attr("r", function (d) { return x(d / 4) + ""; });

		bars2.enter().append("circle")
			.attr('transform', "scale(" + slideScale(State.sliderVal) + ")")
			.attr("cy", function (d, i) { return '50%'; })
			.attr("cx", function (d, i) { return '50%'; })
			.attr("r", function (d) { return x(d / 4) + ""; });

		bars1.enter().append("circle")
			.attr('transform', "scale(" + slideScale(State.sliderVal) + ")")
			.attr("cy", function (d, i) { return '50%'; })
			.attr("cx", function (d, i) { return '50%'; })
			.attr("r", function (d) { return x(d / 4) + ""; });
